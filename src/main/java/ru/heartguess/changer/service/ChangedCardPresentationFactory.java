...
@Service
public class ChangedCardPresentationFactory {

    private Random random = new Random();

    public ChangedCardPresentation resolveChangedCardPresentation(
            CardPresentation cardPresentation, ChangeableParam changeableParam) {
